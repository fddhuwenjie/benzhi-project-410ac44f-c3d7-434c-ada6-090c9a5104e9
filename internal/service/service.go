...
func (s *Service) mutate(m Meta, id, eventType string, fn func(*casework.InterferenceCase) error, summary func(*casework.InterferenceCase) any) (*casework.InterferenceCase, error) {
	return s.mutateContext(context.Background(), m, id, eventType, fn, summary)
}

func (s *Service) mutateContext(ctx context.Context, m Meta, id, eventType string, fn func(*casework.InterferenceCase) error, summary func(*casework.InterferenceCase) any) (*casework.InterferenceCase, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
